    ...
    return (
      ...
      >
        ...
        <List sx={{ padding: 0 }}>
          ...
          >
            <HomeIcon
              sx={{ color: isActive(["/app"]) ? "#ffffff" : "#2c3e50" }}
            />
          </ListItem>
          ...
          >
            <AssessmentIcon
              sx={{ color: isActive(["/dashreports"]) ? "#ffffff" : "#2c3e50" }}
            />
            <ListItemText
              primary="Reports"
              sx={{
                paddingLeft: "10px",
                color: isActive(["/dashreports"]) ? "#ffffff" : "#2c3e50",
              }}
            />
          </ListItem>
          <Divider sx={{ backgroundColor: "#ffffff" }} />
            ...
            <>
              ...
              <ListItem
                ...
                sx={{
                  ...
                  borderRadius: "10px", // Add more rounding to match the design
                  margin: "10px 0", // Add vertical margin between list items
                  backgroundColor: isActive(["/dashplanform", "/dashplantable"])
                    ? "#354a5f"
                    : "inherit",
                }}
              ...
              >
                ...
                <ListItemText
                  ...
                  sx={{
                    paddingLeft: "10px",
                    color: isActive(["/dashplanform", "/dashplantable"])
                      ? "#ffffff"
                      : "#2c3e50",
                  }}
                />
